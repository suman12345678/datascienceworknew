...
ax2 = ax1.twinx()
ax1.plot(temp_min1['temp_min_mean_Beijing']/10, 'y', alpha = 0.75, label = 'Avg Low Temperature Beijing')
ax1.plot(temp_max1['temp_max_mean_Beijing']/10, 'r', alpha = 0.5, label = 'Avg High Temperature Beijing')
...
ax1.set_ylabel('Temp in Beijing')
ax2.set_ylabel('Ocean Temp')
plt.title('Temp in Beijing against \nOcean Temperature in each month')
